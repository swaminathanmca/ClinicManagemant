...
<html ng-app="myApp" ng-controller="PatientHistory">
<head>
...
<div id="wrapper" id="loader">
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h4 class="page-header">Patient History</h4>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
  ...
  <script src="<%=request.getContextPath()%>/static/js/patientHistory.js"></script>
</body>
</html>