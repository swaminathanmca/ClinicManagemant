...
<html  ng-app="myApp"  ng-controller="frontdeskdetail">
<head>
      ...
      <div class="col-lg-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">FrontDesk Details</h3>
          </div>
                  ...
                  <div class="form-group">
                    <div class="col-lg-4">
                      <div class="input-group">
                        ...
                        <input  type="text " ui-mask="999-999-9999" class="form-control" ng-model="x.phone">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="input-group">
...
<script src="<%=request.getContextPath()%>/static/js/FrontDeskDetail.js"></script>
