                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" ng-model="x.pin_code" ng-pattern="/^[0-9]*$/" name="pin_code" required/>
                                            </div>
                                            <span class="text-danger wrapper text-center ng-binding"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                <span class="input-group-addon">PinCode</span>
                                                <input class="form-control" type="text" ng-model="x.Chief_pincode" ng-pattern="/^[0-9]*$/" name="cpincode" required/>
                                            </div>
                                            <span class="text-danger wrapper text-center ng-binding"
