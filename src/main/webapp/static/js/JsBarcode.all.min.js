/**
 * Created by Lissomsoft on 06/07/17.
 */
...
!function (t) {
    ...
    var s = n(1), c = r(s), f = n(0), l = r(f), p = function (t) {
        ...
        return a(e, t), e.prototype.valid = function () {
            ...
            var t = new c["default"], e = [], n = this.getStructure()[this.data[0]], r = this.data.substr(1, 6), o = this.data.substr(7, 6);
    ...
    var i = n(3), a = r(i), u = n(9), s = function () {
        ...
        return t.prototype.render = function () {
            ...
            var e = (0, u.getTotalWidthOfEncodings)(this.encodings), n = (0, u.getMaximumHeightOfEncodings)(this.encodings);
    ...
    var s = n(3), c = r(s), f = n(9), l = "http://www.w3.org/2000/svg", p = function () {
        ...
        return t.prototype.render = function () {
            ...
            for (var e = 0; e < this.encodings.length; e++) {
                var n = this.encodings[e], r = (0, c["default"])(this.options, n.options), o = i(t, r.marginTop, this.svg);
            ...
            var t = (0, f.getTotalWidthOfEncodings)(this.encodings), e = (0, f.getMaximumHeightOfEncodings)(this.encodings), n = t + this.options.marginLeft + this.options.marginRight;
    ...
    var s = n(10), c = r(s), f = n(3), l = r(f), p = n(14), h = r(p), d = n(12), y = r(d), b = n(13), g = r(b), v = n(7), _ = r(v), w = n(11), x = r(w), m = n(6), O = n(8), C = r(O), E = function () {
    }, j = function (t, e, n) {
        var r = new E;
