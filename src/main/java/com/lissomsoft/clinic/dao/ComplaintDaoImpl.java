...
public class ComplaintDaoImpl implements ComplaintDao {
    ...
    public PatientComplaint patientcomplaint(String visit_id) {
        ...
        try{
            ...
            String patientcomplaintSql="select pm.patient_pid,pm.dob,pm.sex,pm.patient_id,pm.first_name,pm.last_name,pv.weight,pv.type,pv.pressure,pv.refereal_details,pv.doctor_detail_id,pv.created_at,pv.height from patient_master pm,patient_visit pv where pm.patient_id=pv.patient_id and pv.visit_id=:visit_id";
