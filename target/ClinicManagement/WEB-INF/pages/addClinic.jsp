              ...
              <form class="form-horizontal ng-invalid" role="form" name="myform" ng-submit="submit()" novalidate>
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input class="form-control" placeholder="Clinic Name" name="branch_name" type="text" ng-model="clinic_name"  required>
                      <span class="text-danger wrapper text-center ng-binding" ng-show="myform.branch_name.$invalid &&  myform.branch_name.$touched">Please Enter Clinic Name</span>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input class="form-control"  name="branch_no" type="text" value="" ui-mask="999-999-9999" ng-model="contact_no" ng-blur="validate()" required>
                  ...
                  <span class="text-danger wrapper text-center ng-binding" ng-show="error_email==false">
                    The Email Already Taken
                      ...
                      <span class="text-danger wrapper text-center ng-binding" ng-show="myform.email.$invalid &&  ! myform.email.$pristine &&  myform.email.$touched "> Enter Valid Email</span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      ...
                      <span class="text-danger wrapper text-center ng-binding" ng-show="myform.address.$invalid &&  myform.address.$touched">Please Enter Address</span>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-3 control-label">City</label>
                    <div class="col-lg-5">
                      <input class="form-control" placeholder="City" name="city" type="text" value="" ng-model="city" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input class="form-control" placeholder="State" name="state" type="text" value="" ng-model="state" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input class="form-control" placeholder="PinCode" name="pincode" type="text" value="" ng-model="pincode" maxlength="6" ng-pattern="/^[0-9]*$/" required>
                      <span class="text-danger wrapper text-center ng-binding" ng-show="myform.pincode.$error.pattern">Please Enter Valid Pin Code</span>
                      <span class="text-danger wrapper text-center ng-binding" ng-show="myform.pincode.$invalid &&  myform.pincode.$touched">Please Enter Pin Code</span>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-actions">
                    <div class="row">
                      <div class="col-lg-offset-4 col-lg-7">
                        <button type="submit" class="btn btn-success" ng-disabled="myform.$invalid || !authError || !authErrorEmail " ng-click="submitted=true">Save </button>
